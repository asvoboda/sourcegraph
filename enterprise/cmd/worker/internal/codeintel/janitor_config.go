...
func (c *janitorConfig) Load() {
	...
	c.CacheMaxKeys = c.GetInt("PRECISE_CODE_INTEL_RETENTION_CACHE_MAX_KEYS", "10000", "The number of maximum keys used to cache the set of branches visible from a commit.")
}
